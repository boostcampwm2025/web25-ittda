...
export class InitialMigration1767689878926 implements MigrationInterface {
  name = 'InitialMigration1767689878926';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "groups" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "owner_id" uuid, CONSTRAINT "PK_659d1483316afb28afd3a90646e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."folders_templatetype_enum" AS ENUM('DIARY', 'MOVIE', 'MUSICAL', 'THEATER', 'TRAVEL', 'MEMO', 'ETC')`,
    );
    await queryRunner.query(
      `CREATE TABLE "folders" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "templateType" "public"."folders_templatetype_enum" NOT NULL, "isDefault" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "ownerId" uuid, "groupId" uuid, CONSTRAINT "PK_8578bd31b0e7f6d6c2480dbbca8" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."posts_templatetype_enum" AS ENUM('DIARY', 'MOVIE', 'MUSICAL', 'THEATER', 'TRAVEL', 'MEMO', 'ETC')`,
    );
    await queryRunner.query(
      `CREATE TABLE "posts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "templateType" "public"."posts_templatetype_enum" NOT NULL, "title" character varying NOT NULL, "content" text NOT NULL, "location" geometry(Point,4326), "visitedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "authorId" uuid, "groupId" uuid, "folderId" uuid, CONSTRAINT "PK_2829ac61eff60fcec60d7274b9e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_ddb43799b8e58d04404d3d533f" ON "posts" USING GiST ("location") `,
    );
    await queryRunner.query(
      `CREATE TABLE "trash" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "expiredAt" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "postId" uuid, CONSTRAINT "REL_d8851ee9918f1649ca8fb8be16" UNIQUE ("postId"), CONSTRAINT "PK_cbaebd47a9c109b81eb72e8004a" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "posts" ADD CONSTRAINT "FK_16292d40fa12e5ee304f7b9e794" FOREIGN KEY ("folderId") REFERENCES "folders"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "posts" DROP CONSTRAINT "FK_16292d40fa12e5ee304f7b9e794"`,
    );
    await queryRunner.query(
