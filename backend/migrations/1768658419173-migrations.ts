...
export class Migrations1768658419173 implements MigrationInterface {
  name = 'Migrations1768658419173';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "posts" ADD "images" text array`);
    await queryRunner.query(
      `ALTER TABLE "posts" ADD "emotion" character varying(50)`,
    );
    await queryRunner.query(
