...
export default function Tag({ children, onClick, className }: TagProps) {
  return (
    <button
      onClick={onClick}
      className="text-sm rounded-4xl bg-white font-medium cursor-pointer border-[0.5px] border-itta-gray2 hover:border-itta-point transition-all duration-300 ease-in-out"
    >
      <div
        className={cn(
