...
export default function GalleryDrawer({
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-2 max-h-[45vh] overflow-y-auto hide-scrollbar mb-8">
          ...
          return (
            <DrawerClose key={idx} asChild>
              <button
                ...
                className={cn(
                  'cursor-pointer aspect-square relative rounded-xl overflow-hidden transition-all active:scale-95 border-2',
      ...
      <DrawerClose className="cursor-pointer w-full py-4 rounded-2xl font-bold text-sm dark:bg-white/5 dark:text-gray-500 bg-itta-black text-white">
        닫기
      </DrawerClose>
    </>
  );
