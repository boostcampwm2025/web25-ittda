...
export default function GroupEditClient({
  ...
  return (
    ...
    >
      <header className="sticky top-0 z-50 backdrop-blur-md py-4 flex items-center justify-between border-b transition-colors duration-300 dark:bg-[#121212]/95 dark:border-white/5 bg-white/95 border-gray-50">
