  ...
  return (
    <>
      ...
      >
        <DrawerTrigger
          aria-label="멤버 초대"
          data-tutorial-id="tutorial-group-invite"
          className="cursor-pointer p-2 sm:p-2.5 rounded-xl transition-all active:scale-95 dark:bg-white/5 dark:text-[#10B981] bg-gray-50 text-[#10B981]"
        >
      ...
      <SocialShareDrawer
        path={getFullInviteUrl(inviteResult?.code || '')}
        title="잇다- 그룹 초대"
        ...
        record={{
          id: groupId,
          title: '잇다- 그룹 초대',
          content: '기억과 맥락을 잇는 공간, 잇다-로 함께해요!',
          image: null,
        }}
      />
    </>
