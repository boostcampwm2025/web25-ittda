      ...
      <DrawerContent className="w-full px-8 pt-4 pb-12">
        ...
        {isLoading ? (
          ...
          <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex flex-col items-center justify-center py-10 px-6 rounded-3xl bg-red-50 dark:bg-red-500/5 border border-red-100 dark:border-red-500/10 text-center">
              <div className="w-16 h-16 bg-red-100 dark:bg-red-500/20 rounded-full flex items-center justify-center mb-6">
                <ShieldAlert className="w-8 h-8 text-red-500" />
              </div>
              <h3 className="text-lg font-bold text-itta-black dark:text-white mb-2">
                초대 권한이 없습니다
              </h3>
            ...
            <DrawerClose className="cursor-pointer w-full py-4 rounded-2xl font-bold text-sm bg-itta-black text-white dark:bg-white dark:text-itta-black shadow-xl active:scale-95 transition-all">
              확인 후 닫기
            </DrawerClose>
          </div>
        ) : (
