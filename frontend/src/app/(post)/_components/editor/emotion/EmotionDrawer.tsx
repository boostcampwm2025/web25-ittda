      ...
      <DrawerContent>
        <div className="mx-auto w-full p-8 pb-12">
          ...
          <section className="flex flex-row w-full gap-3">
            ...
            <DrawerClose className="flex-1 w-full py-4 rounded-2xl font-bold text-sm bg-[#333333] text-white active:scale-95 transition-transform dark:bg-white dark:text-black">
              확인
            </DrawerClose>
          </section>
        </div>
