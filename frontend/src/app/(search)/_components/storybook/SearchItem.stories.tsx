...
const mockRecord: RecordSearchItem = {
  ...
  content: '오늘 성수동에서 카페를 여러 곳 방문했다. 분위기도 좋고 커피도 맛있었다.',
...
- **thumbnailMediaId**: 값이 있으면 썸네일 이미지 표시, 없으면 이미지 아이콘으로 대체
...
export const NoThumbnail: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: '썸네일 이미지가 없는 경우 — 이미지 자리에 이미지 아이콘이 표시된다.',
      },
    },
  },
};
...
export const Minimal: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: '스니펫·주소가 없는 최소 구성의 기록 아이템 — 제목과 날짜만 표시된다.',
      },
    },
  },
};
